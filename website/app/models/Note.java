...
public class Note extends Model {
    ...
    public Note(String title, String content, int startTime, Video video, User user, ArrayList<Tag> noteTags) {
        super();
        this.title = title;
    ...
    public Note(String title, String content, int startTime, Video video, User user, ArrayList<Tag> noteTags, long visited) {
        super();
        this.title = title;
        this.content = content;
        this.startTime = startTime;
